...
struct LagunaTargetWeights {
    ...
    // Per-layer head count. The loader replaces this with exactly n_layer
    // entries from GGUF metadata; the defaults preserve the 40-layer XS.2 shape.
    std::vector<int> n_head_arr = {
