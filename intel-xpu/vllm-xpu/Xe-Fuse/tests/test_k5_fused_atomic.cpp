...
//
// Tests GemmRmsNormPartialCrossEntropyFused: GEMM + RMSNorm epilogue atomically
// writes lse[M] directly during the GEMM, no post-GEMM combine step needed.

#include "xe-fuse/kernels/gemm_rmsnorm_partial_cross_entropy_fused_atomic.hpp"
...
int main(int argc, const char** argv) {
  ...
  // lse buffer is passed directly; initialize_workspace fills it with -infinity.
  auto evt_args = K5F::make_evt_args(block_rstd.get(), M, block_lse.get(), N, L);
