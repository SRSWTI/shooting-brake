...
Runs the fixed correctness prompts and performance workload from src/phase0/
against the NVFP4 model on the RTX 5090.

Usage:
    source .venv/bin/activate
    python src/phase0/benchmark_cuda.py --mode eager
    python src/phase0/benchmark_cuda.py --mode graph
"""
