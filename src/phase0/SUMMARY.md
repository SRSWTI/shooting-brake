...
**Phase 0 remains complete. Phases 1, 2, and 3 are also complete. Phase 3 evidence is generated and authenticated by `src/phase3/generate_reference.py`, frozen in `src/phase3/reference_fixture.bin`, and exercised by `src/phase3/provider_math_test`; proceed to Phase 4 (the Qwen-scoped upstream-vLLM out-of-tree adapter).**
